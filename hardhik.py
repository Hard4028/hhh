disease_dictionary = [
    {
        ...
        "answer": {
            "diseases": ["Nutrient Deficiency", "Overwatering", "Chlorosis"],
    ...
    },
    {
        ...
        "answer": {
            "diseases": ["Underwatering", "Root Rot", "Fusarium Wilt"],
    ...
    },
    {
        ...
        "answer": {
            "diseases": ["Root Rot", "Nutrient Deficiency", "Pest Infestation"],
    ...
    },
    {
        ...
        "answer": {
            "diseases": ["Pest Infestation", "Environmental Stress", "Bacterial Leaf Scorch"],
    ...
    },
    {
        ...
        "answer": {
            "diseases": ["Nutrient Deficiency", "Root Damage", "Viral Infections"],
            "causes": ["Lack of nitrogen, phosphorus, or potassium", "Damage to the root system by pests (e.g., nematodes, root aphids)"],
            "solutions": ["Apply a balanced fertilizer rich in nitrogen, phosphorus, and potassium", "Improve soil drainage and aeration to prevent root compaction", "Use organic compost to improve soil structure and fertility"]
        }
    },
    {
    ...
    },
    {
        ...
        "answer": {
            ...
            "causes": ["Excess moisture on leaves"],
            "solut
